  ...
  return (
    <>
      ...
      <ContentWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-[26px] gap-[16px] p-[16px] lg:p-[26px]">
          ...
          <div className="flex flex-col gap-[16px]">
            ...
            <p className="text-gray-700 font-[400] md:text-[16px] text-[14px]">
              At Speed Cart, we're passionate about making Shopify stores quicker, more innovative, and more lucrative. Constructed by the
              team at DaisyDiffusion.com, we concentrate on establishing high-performance Shopify apps that fix real problems for modern
              merchants.
            </p>
            <p className="text-gray-700 font-[400] md:text-[16px] text-[14px]">
              From cart modification to checkout optimization and sales recovery, Speed Cart is created to give you overall control over
              your shop's cart experience. It helps you quickly enhance conversions, boost order value, and recover lost sales.
              <br></br>
              <br></br>
              We're not new to this. Our Shopify app household also includes Assurify (product warranty and protection strategies). ChargeUp
              helps Shopify merchants boost order value by adding customizable extra fees and service charges at checkout, which are relied
              on by numerous Shopify merchants worldwide.
            </p>
          </div>
        </div>
      </ContentWrapper>
      ...
      <ContentWrapper>
        ...
        <TopRight />
        <HeadingSection
          heading1="Why We Build "
          heading2="Shopify Apps"
          description="Merchants deserve practical, user-friendly tools developed with growth in mind. Our objective is to simplify e-commerce management and help brands open new earnings chances without technical headaches. 
"
          ...
          <div className="flex flex-col lg:col-span-3 col-span-1 lg:border-b-0 border-b-[1px] border-gray-200 min-h-0">
            ...
            <div className="relative flex-1 border-b-[1px] border-gray-200 lg:p-[26px] p-[16px]">
              ...
              <div className="bg-[url('/images/footer-bg.svg')] bg-cover bg-center w-full h-full rounded-xl flex flex-col lg:gap-2 gap-[24px] p-[16px]">
                <p className="font-[600] lg:text-[24px] text-[20px] text-white">Customize Cart Without Code</p>
            ...
            <div className="flex-1 relative lg:p-[26px] p-[16px]">
              ...
              <div className="w-full h-full rounded-xl flex flex-col lg:gap-2 gap-[24px] justify-between p-[16px] bg-[#F6F6F6]">
                <p className="text-gray-900 lg:text-[16px] text-[14px] font-[400]">
                  <span className="font-[600]"> Were here for you.</span> Our support team is available 24/7 tro assist with any questions
                  or issues
                </p>
                <div className="flex">
      ...
      <ContentWrapper>
        ...
        <TopRight />
        <HeadingSection
          heading1="Sign up with"
          heading2="the Community"
          description="Speed Cart combines powerful customization, upsells, and recovery tools in one lightweight, high-performance Shopify app"
          align="text-left max-w-[700px]"
        />
        <GrayLine />
        <div className="flex relative lg:flex-row flex-col lg:gap-[26px] gap-[16px] lg:px-[26px] px-[16px] lg:py-[28px] p-[16px]">
          ...
          <div className="lg:w-[60%] w-full lg:py-[26px] py-0">
            ...
            <p className="text-gray-700 font-[400] md:text-[16px] text-[14px] lg:py-[24px] py-4">
              Countless Shopify store owners rely on apps developed by DaisyDiffusion to grow smarter, sell better, and serve faster. From
              customizing checkout experiences with Speed Cart to offering product protection with{" "}
              <a href="https://apps.shopify.com/assurify" target="_blank" rel="noopener noreferrer" className=" font-[500] underline ">
                Assurify Shipping Protection
              </a>{" "}
              and increasing client lifetime value through{" "}
              <a
              ...
              , we build tools designed to boost every stage of your e-commerce journey. Our mission is to assist merchants with
              easy-to-use, conversion-focused solutions that deliver real, measurable results. We’re more than just an app provider — we’re
              a community. Join our growing network of Shopify entrepreneurs, marketers, and developers on{" "}
              <a href="https://discord.com/invite/pCAjH2Vu" target="_blank" rel="noopener noreferrer" className=" font-[500] underline ">
                Discord{" "}
              </a>{" "}
              to swap insights, get support, share feedback, and stay ahead of the curve together.
            </p>
            <p className="lg:text-[20px] text-[16px] font-[500] text-gray-900">
              Check out more at{" "}
              <a href="https://DaisyDiffusion.com" target="_blank" rel="noopener noreferrer" className=" text-[16px] font-[400] underline ">
                DaisyDiffusion.com.
              </a>
            </p>
          </div>
          <div className="lg:w-[40%] w-full flex flex-col lg:gap-[32px] gap-4">
            <AboutCard
              image="/images/community1.svg"
              title="Sped Cart App"
              description="At Speed Cart, we're passionate about making Shopify stores quicker"
            />
            <AboutCard
              image="/images/community2.svg"
              title="Assurify Shipping Protection"
              description="Maximize revenue with own Shipping Protection App, reduce damage, loss risks, and enhance warranty."
            />
            <AboutCard
              image="/images/community3.svg"
              title="Chargeup Extra Fee"
              description="Add customizable fees to your store for enhanced customer options and increased revenue."
            />
          </div>
        </div>
      </ContentWrapper>
