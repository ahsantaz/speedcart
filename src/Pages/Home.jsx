...
import FaqAccordion from '../Components/FaqAccordin'
import ShinyOrangeButton from '../Components/buttons/ShinyOrangeButton'
import HeadingFlex from '../Components/heading-flex'
...
<ContentWrapper>
  <HeadingSection heading1="Our core" heading2="feature" description="Simplify cart management, boost sales, and recover lost revenue with our easy, powerful features." align="text-center mx-auto" />
   ...
   <div className="grid grid-cols-1 md:grid-cols-2">
    ...
    <div className='lg:p-[26px] p-[18px]   md:border-r-[2px] border-t-[2px] border-gray-200'>
<FeatureCard heading="Card Editor" description="Customize cart layouts, colors, promotions, product suggestions, trust badges, and more." background= "bg-[#E8F1FB]" image="/images/feature1.png" link=""/>
    ...
    <div className='lg:p-[26px] p-[18px]  border-t-[2px]  border-gray-200'>
<FeatureCard heading="Sticky Cart" description="Keep a floating cart button always visible for faster, friction-free checkouts from any page." background= "bg-[#FCF9E8]" image="/images/feature2.png" link=""/>
    ...
    <div className='lg:p-[26px] p-[18px]  border-t-[2px] md:border-r-[2px]  border-gray-200'>
...
<HeadingFlex heading1="Speed cart is built to " heading2="convert to a conversion." description="Powerful, scalable, and designed to convert — trusted by stores worldwide to boost sales and streamline checkout." align="text-left" />
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t-[2px]  border-gray-200">
  {/* Card 1 */}
  <div className="border-b-[2px] md:border-r-[2px] border-gray-200 relative group lg:p-[26px] p-[18px] bg-white overflow-hidden cursor-pointer">
  ...
  {/* Card 2 */}
  <div className="border-b-[2px]  lg:border-r-[2px] border-gray-200 relative group lg:p-[26px] p-[18px]  bg-white overflow-hidden cursor-pointer">
  ...
  {/* Card 3 */}
  <div className="border-b-[2px] lg:border-r-0 md:border-r-[2px] border-gray-200 relative group lg:p-[26px] p-[18px]  bg-white overflow-hidden cursor-pointer">
  ...
  {/* Card 4 */}
  <div className="  lg:border-r-[2px] border-b-[2px] lg:border-b-0 border-gray-200 relative group lg:p-[26px] p-[18px]  bg-white overflow-hidden cursor-pointer ">
  ...
  {/* Card 5 */}
  <div className=" md:border-r-[2px] lg:border-b-0 border-b-[2px] md:border-b-0   border-gray-200 relative group lg:p-[26px] p-[18px]  bg-white overflow-hidden cursor-pointer">
  ...
  {/* Card 6 */}
  <div className="border-r-0  border-gray-200  relative group lg:p-[26px] p-[18px]  bg-white overflow-hidden cursor-pointer">
...
<GrayLine />
  <div className='lg:py-[28px] lg:px-[26px] px-[18px] py-6'> 
  <SlideCarousel />
  </div>
 </ContentWrapper>
...
<GrayLine />
  <div className='grid md:grid-cols-3 grid-cols-1 lg:gap-[26px] lg:p-[26px] gap-[18px] p-[18px] '>
    <BlogCard />
    <BlogCard />
    <BlogCard />
  </div>
