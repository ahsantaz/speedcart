  ...
  return (
    <>
      ...
      <ContentWrapper>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className= 'relative lg:p-[26px] p-[16px]   md:border-r-[1px] border-t-[1px] border-gray-200'>
                <TopLeft />
              <TopRight />
          ...
          <div className='relative lg:p-[26px] p-[16px]  border-t-[1px] md:border-r-[1px]  border-gray-200'>
               <TopLeft />
              <TopRight />
    ...
    <TopLeft />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t-[1px]  border-gray-200">
          ...
          {/* Card 5 */}
          <div className=" md:border-r-[1px] lg:border-b-0 border-b-[1px] md:border-b-0   border-gray-200 relative group lg:p-[26px] p-[16px]  bg-white  cursor-pointer">
                <TopLeft />
              <TopRight />
              <BottomRight />
      ...
      <ContentWrapper>
        ...
        <GrayLine />
        <div className='relative lg:py-[28px] lg:px-[26px] px-[16px] py-6'>
              <TopLeft />
              <TopRight />
          <SlideCarousel />
        </div>
      ...
      <ContentWrapper>
        ...
        <GrayLine />
        <div className='relative grid md:grid-cols-3 grid-cols-1 lg:gap-[26px] lg:p-[26px] gap-[16px] p-[16px] '>
              <TopLeft />
              <TopRight />
          <BlogCard />
          <BlogCard />
