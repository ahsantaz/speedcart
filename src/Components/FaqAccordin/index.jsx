...
export default function FaqAccordion({ questions }) {
  ...
  return (
    <div className="w-full mx-auto lg:px-[26px] px-[18px] lg:py-[32px] py-6" id="accordion">
      {questions.map((item, index) => {
        const isOpen = openIndex === index;

        return (
          <div key={index} className="bg-[#F6F6F6]  overflow-hidden rounded-[12px] lg:mb-[28px] mb-[18px] ">
            <button
  ...
  <g clip-path="url(#clip0_2167_3610)">
    ...
    <clipPath id="clip0_2167_3610">
      <rect width="20" height="20" fill="white"/>
            ...
            <div
              ...
              className="transition-all duration-500 ease-in-out overflow-hidden bg-[#F6F6F6] px-4"
            >
