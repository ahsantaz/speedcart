  ...
  return (
    <div className="relative rounded-2xl group overflow-hidden border-[1px] border-gray-300">
      ...
      <div className="relative z-10 flex flex-col gap-3 p-4 select-none">
        <p className="font-[400] text-gray-500 text-[14px] group-hover:text-white transition-all duration-400">
          22 May, 2025
        </p>
        ...
        <p className="font-[400] text-gray-500 text-[14px] group-hover:text-white transition-all duration-600">
          Read more...
        </p>
      </div>
